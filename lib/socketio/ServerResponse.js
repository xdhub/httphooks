...
var ServerResponse = function (opts) {
    ...
    var privateProperties = {
        socket: {
            context: opts.socketContext || new events.EventEmitter(),
            connectionClosed: false,
            responseCallback: typeof opts.socketResponseCallback === 'undefined'
                              ? function () {}
    ...
    this.write = function (data, encoding) {
        privateProperties.data.push(data);
        if (encoding) {
            privateProperties.encoding = encoding;
        }
    };
    ...
    this.end = function (data, encoding) {
        ...
        if (!privateProperties.socket.connectionClosed) {
            ...
            sendResponse.call(this, this.statusCode, privateProperties.headers, privateProperties.data, privateProperties.socket.responseCallback);
        } else {
