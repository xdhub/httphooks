...
function createHttpContextFromSocket(socketContext, request, responseCallback) {
    return null;
}
...
function dispatchSocketRequest(socketContext) {
    socketContext.on('request', function (request, responseCallback) {
        if (isValidSocketRequest(request)) {
            var httpContext = createHttpContextFromSocket(socketContext, request, responseCallback);
        } else {
