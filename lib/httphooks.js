...
var HttpHooks = function (options) {
    ...
    options.defaultResponder = options.defaultResponder || null;
    if (options.defaultResponder !== null && typeof options.defaultResponder !== 'function') {
        throw new TypeError('Invalid options defaultResponder type: expected a function or null');
    }

    options.noMatchHandler = options.noMatchHandler || respondWithNotFoundStatusCode;
...
function processingStage(hooks, httpContext, chainCallback) {
    ...
    if (responderHooks.length > 0) {
        ...
        var defaultResponderHook = {
            ...
            type: type,
            callback: this.defaultResponder
        };
...
function processRequest(httpContext) {
    ...
    if (hooks.length > 0 || this.defaultResponder) {
