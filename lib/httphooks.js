...
function loadCallbackFunction(modulePath, functionName) {
    var module = null;
    var func = null;
    try
    {
...
function createFunctionFromCallbackInfo(callback) {
    ...
    return loadCallbackFunction(modulePath, callback.func);
}
...
function executeHook(hookExecutionContext, executionCompleteCallback) {
    ...
    try {
        ...
        if (typeof hook.callback === 'object') {
            hook.callback = createFunctionFromCallbackInfo(hook.callback);
        }
...
HttpHooks.prototype.onNoMatch = function (callback) {
    ...
    this.noMatch = typeof callback === 'object' ? createFunctionFromCallbackInfo(callback) : callback;
};
